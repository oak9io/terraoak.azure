...
resource "azurerm_application_gateway" "randy_gateway" {
  ...
  ssl_policy {
    ...
    # allowed suites : https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/application_gateway#cipher_suites
    # still need to set preferred for blueprint and allowed list is outdated
